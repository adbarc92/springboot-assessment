...
public class ProductsControllerTest {
   ...
   * @throws Exception
   *
   *                   It tests updating retail price and availability of a
   *                   product
   */
  @Test
  @Order(7)
   ...
   * @throws Exception
   *
   *                   It tests updating discount price and availability of a
   *                   product
   */
  @Test
  @Order(8)
   ...
   * @throws Exception
   *
   *                   It tests updating retail price, discount price and
   ...
   * @throws Exception
   *
   *                   It tests finding a product with a given category and
   *                   availability
   */
  @Test
  @Order(15)
  public void findProductsByCategoryAndAvailability() throws Exception {
    ...
    String actual = mockMvc.perform(get("/products?category=Full%20Body%20Outfits&availability=1"))
        .andExpect(status().isOk())
        .andReturn()
        .getResponse()
        .getContentAsString();
